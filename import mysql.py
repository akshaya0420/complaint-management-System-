...
def add_complaint():
    ...
    tk.Label(complaint_window, text="Name").pack(pady=5)
    entry_name = tk.Entry(complaint_window)
    entry_name.pack(pady=5)

    tk.Label(complaint_window, text="Department").pack(pady=5)
    entry_department = tk.Entry(complaint_window)
    entry_department.pack(pady=5)

    tk.Label(complaint_window, text="Complaint Description").pack(pady=5)
    entry_complaint = tk.Entry(complaint_window)
    entry_complaint.pack(pady=5)

    tk.Button(complaint_window, text="Submit", command=submit_complaint).pack(pady=10)
...
def withdraw_complaint():
    ...
    tk.Label(withdraw_window, text="Complaint ID").pack(pady=5)
    entry_complaint_id = tk.Entry(withdraw_window)
    entry_complaint_id.pack(pady=5)

    tk.Button(withdraw_window, text="Withdraw", command=remove_complaint).pack(pady=10)
...
def main_interface():
    ...
    tk.Label(root, text=f"Welcome, {logged_in_user}", font=("Helvetica", 16)).pack(pady=20)

    tk.Button(root, text="Register Complaint", command=add_complaint).pack(pady=10)
    tk.Button(root, text="View Complaints", command=view_complaints).pack(pady=10)
    tk.Button(root, text="Withdraw Complaint", command=withdraw_complaint).pack(pady=10)
    tk.Button(root, text="Logout", command=logout).pack(pady=10)

# Initial window for login and signup options
def initial_window():
    tk.Label(root, text="Welcome to Complaint Management System", font=("Helvetica", 18)).pack(pady=20)
